...
describe('XL Single Approval', function() {
  ...
  it('Berita Acara Serah Terima Submit Request Approval', async function() {
    ...
    //form
    await driver.findElement(By.css("#kt_wizard_v1 > div.row.my-10.my-lg-15.px-lg-12.ng-star-inserted > div > form > div.card.card-custom.pb-5 > div > div:nth-child(3) > div > input")).sendKeys('Berita Acara Serah Terima Paralel');
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-97 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-103")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-169 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-172")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-243")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-313 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-388")).click();
    await driver.sleep(2000);
