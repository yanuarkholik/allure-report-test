...
describe('XL Single Approval', function() {
  ...
  it('Standar Operational Procedure Submit Request Approval', async function() {
    ...
    await driver.findElement(By.css("#mat-option-0 > span > ngx-mat-select-search > div > input")).sendKeys('Standard Operational Procedure');
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-38 > span")).click();
    ...
    //form
    await driver.findElement(By.css("#kt_wizard_v1 > div.row.my-10.my-lg-15.px-lg-12.ng-star-inserted > div > form > div.card.card-custom.pb-5 > div > div:nth-child(3) > div > input")).sendKeys('Standard Operational Procedure Paralel');
    await driver.findElement(By.xpath('//*[@id="kt_wizard_v1"]/div[2]/div/form/div[1]/div/div[4]/div/div/div/textarea')).sendKeys('Standard Operational Procedure Paralel');
    ...
    await driver.findElement(By.css("#kt_wizard_v1 > div.row.my-10.my-lg-15.px-lg-12.ng-star-inserted > div > form > div.card.card-custom.pb-5 > div > div:nth-child(9) > div > app-date-select > div > div > input")).sendKeys('20-10-2028');
    await driver.sleep(5000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-92")).click(); 
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-99 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-102")).click(); 
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-171 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-177")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-243 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-318")).click();
    await driver.sleep(2000);
