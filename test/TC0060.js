...
describe('XL Single Approval - Role Management', function() {
  ...
  it('Show List Role', async function() {
    ...
    //Assertion
    let validasi = await driver.findElement(By.xpath('//*[@id="kt_content"]/div/div/app-role-user/div/div[1]/div[1]/h3')).getText();
    expect(validasi).to.contains("Role Management");
  })
})
