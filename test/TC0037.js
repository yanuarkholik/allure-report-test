...
describe('XL Single Approval', function() {
  ...
  it('Standar Operational Procedure Submit Request Approval - Sequential', async function() {
    ...
    await driver.sleep(2000);
    await driver.findElement(By.css("#email")).sendKeys('sustiyah@xl.co.id');
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-36 > span")).click();
    ...
    await driver.sleep(5000);
    await driver.findElement(By.xpath('//*[@id="mat-option-94"]/span/ngx-mat-select-search/div/input')).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-96")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-159 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-162")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-224 > span > ngx-mat-select-search > div > input")).sendKeys('t');
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-292")).click();
    await driver.sleep(2000);
