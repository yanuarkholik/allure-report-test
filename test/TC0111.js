...
describe('XL Single Approval', function() {
  ...
  it('Homepass Request Submit Request Approval - Sequential', async function() {
    ...
    await driver.sleep(5000);
    await driver.findElement(By.xpath('//*[@id="mat-option-21"]')).click();
    await driver.sleep(1000);
    await driver.findElement(By.css("#mat-select-value-3")).click();
    await driver.sleep(5000);
    await driver.findElement(By.xpath('//*[@id="mat-option-49"]')).click();
    ...
    //form
    await driver.findElement(By.css("#kt_wizard_v1 > div.row.my-10.my-lg-15.px-lg-12.ng-star-inserted > div > form > div.card.card-custom.pb-5 > div > div:nth-child(4) > div > input")).sendKeys('HOMEPASS REQUEST - GROUP APPROVAL');
