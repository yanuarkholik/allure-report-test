...
describe('Detail Master SK', function() {
  ...
  it('sk', async function() {
    ...
    await driver.sleep(3000);
    //Klik Sub Menu SK
    await driver.findElement(By.xpath("//*[@class='py-5 md:py-0']/nav/ul/li[4]/ul/li[17]/a")).click();
    await driver.sleep(3000);
    let list = await driver.findElement(By.css('h2[class="text-lg font-medium mr-auto flex-none"]')).getText();
    expect(list).to.equal('List SK')
    await driver.sleep(3000);
  })
})
