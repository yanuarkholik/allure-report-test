...
describe ('SIMPATIK', function() {
  ...
  it('NEGARA', async function() {
    ...
    await driver.sleep(3000);
    await driver.findElement(By.xpath('/html/body/div[5]/div/div[2]/div[3]/div/div/table/thead/tr/th[3]'));
    await driver.sleep(3000);
    var doubleClick = driver.findElement(By.xpath('/html/body/div[5]/div/div[2]/div[3]/div/div/table/thead/tr/th[3]'));
    var actions = driver.actions({bridge: true});
    actions.doubleClick(doubleClick).perform();
    await driver.sleep(3000);
    //Konfirmasi Descending
    let desc = await driver.findElement(By.xpath('/html/body/div[5]/div/div[2]/div[3]/div/div/table/tbody/tr[1]/td[3]')).getText();
    expect(desc).to.equal('Zimbabwe');
  });
});