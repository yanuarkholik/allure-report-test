...
describe('MASTER DATA KATEGORI PELANGGARAN', function() {
  ...
  it('[Kategori Pelanggaran] Administrator tidak dapat tambah Kategori Pelanggaran dengan inputan lebih dari 100 karakter  ', async function() {
    ...
    expect(mandatory_txt_value).to.contains('Kategori Pelanggaran maksimal berisi 255 karakter.');
