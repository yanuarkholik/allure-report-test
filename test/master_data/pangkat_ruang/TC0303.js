...
describe ('SIMPATIK', function() {
  ...
  it('NEGARA', async function() {
    ...
    await driver.findElement(By.xpath("/html/body/div[5]/div/div[2]/div[3]/form/div/div[1]/input")).sendKeys("Pembina");
    await driver.sleep(1000);
    await driver.findElement(By.className("btn btn-primary shadow-md")).click();
    await driver.sleep(1000);
    //Bersihkan Pencarian
    await driver.findElement(By.className("btn btn-primary-soft")).click();
    await driver.sleep(1000);
  });
});