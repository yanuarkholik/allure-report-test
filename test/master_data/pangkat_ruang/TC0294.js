...
describe ('SIMPATIK', function() {
  ...
  it('NEGARA', async function() {
    ...
    await driver.sleep(3000);
    //Detail Pangkat Ruang
    await driver.findElement(By.xpath("/html/body/div[5]/div/div[2]/div[3]/div/div/table/tbody/tr[4]/td[7]/div/button[1]")).click();
    await driver.sleep(3000);
    //Konfirmasi Halaman Detail
    let konfirmasiDetail = await driver.findElement(By.xpath('/html/body/div[5]/div/div[2]/div[1]/div[1]/h3')).getText();
    expect(konfirmasiDetail).to.equal('Detail Pangkat Ruang');
  });
});
