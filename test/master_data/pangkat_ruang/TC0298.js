...
describe ('SIMPATIK', function() {
  ...
  it('NEGARA', async function() {
    ...
    //Teks
    await driver.findElement(By.xpath('//*[@id="modal-create-body"]/form/div/div[1]/div/input')).sendKeys('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent placerat nulla sed finibus congue. Aliquam tincidunt non nisi sed tincidunt. Curabitur porta mauris posuere risus ultricies, vel iaculis arcu luctus. Nulla non dignissim velit. Nam id ex vitae ipsum pharetra porta. Nam ullamcorper ipsum magna, placerat luctus ligula suscipit vel. Maecenas eget magna ante. Praesent mattis tristique diam, at commodo ante tempus vel. In ac neque ut eros blandit iaculis vel ut orci. Curabitur tempus iaculis malesuada. Nulla accumsan nibh nisl, non ultricies risus posuere id. Nulla vel justo at augue imperdiet tristique. Pellentesque vel ultrices ante. Pellentesque id bibendum mi. Suspendisse tempor sed nunc a malesuada. Fusce id urna tristique justo tempus fermentum nec eget lectus. Nam tempus et metus quis vulputate. Quisque sagittis, est ut suscipit venenatis, quam diam hendrerit turpis, eget bibendum ipsum sem sit amet nisl.');
    await driver.sleep(1000);
    //Golongan
    ...
    await driver.sleep(1000);
    //Pangkat
    await driver.findElement(By.xpath('//*[@id="modal-create-body"]/form/div/div[4]/div/input')).sendKeys('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent placerat nulla sed finibus congue. Aliquam tincidunt non nisi sed tincidunt. Curabitur porta mauris posuere risus ultricies, vel iaculis arcu luctus. Nulla non dignissim velit. Nam id ex vitae ipsum pharetra porta. Nam ullamcorper ipsum magna, placerat luctus ligula suscipit vel. Maecenas eget magna ante. Praesent mattis tristique diam, at commodo ante tempus vel. In ac neque ut eros blandit iaculis vel ut orci. Curabitur tempus iaculis malesuada. Nulla accumsan nibh nisl, non ultricies risus posuere id. Nulla vel justo at augue imperdiet tristique. Pellentesque vel ultrices ante. Pellentesque id bibendum mi. Suspendisse tempor sed nunc a malesuada. Fusce id urna tristique justo tempus fermentum nec eget lectus. Nam tempus et metus quis vulputate. Quisque sagittis, est ut suscipit venenatis, quam diam hendrerit turpis, eget bibendum ipsum sem sit amet nisl.');
    await driver.sleep(1000);
    //Klik Simpan
