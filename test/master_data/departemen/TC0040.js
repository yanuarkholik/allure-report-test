...
describe('MASTER DATA DEPARTEMEN', function() {
  ...
  it('Dapat tambah data sub menu Departemen dengan inputan kosong', async function() {
    ...
    await driver.wait(until.elementsLocated(By.xpath("//*[contains(text(), 'Kode Departemen wajib diisi.')]")));
    await driver.wait(until.elementsLocated(By.xpath("//*[contains(text(), 'Nama Departemen wajib diisi.')]")));
  })
})