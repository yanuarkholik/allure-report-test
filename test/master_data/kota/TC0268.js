...
describe ('SIMPATIK', function() {
  ...
  it('KOTA', async function() {
    ...
    await driver.sleep(3000);
    //Cari Kota dengan Keyword yang Tidak Sesuai
    await driver.findElement(By.className("form-control px-10")).sendKeys("KABUPATEN PALEMBANG");
    await driver.sleep(1000);
    await driver.findElement(By.className("btn btn-primary shadow-md")).click();
    await driver.sleep(3000);
    //Konfirmasi Pencarian Tidak Sesuai
