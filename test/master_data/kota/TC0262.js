...
describe ('SIMPATIK', function() {
  ...
  it('KOTA', async function() {
    ...
    await driver.sleep(3000);
    //Ubah Kota
    await driver.findElement(By.xpath("/html/body/div[5]/div/div[2]/div[3]/div/div/table/tbody/tr[1]/td[5]/div/button[2]")).click();
    await driver.sleep(3000);
    await driver.findElement(By.xpath('//*[@id="modal-edit-body"]/form/div/div[1]/div/div/div')).click();
    await driver.sleep(1000);
    await driver.findElement(By.id("tomselect-1-opt-2")).click();
    await driver.sleep(1000);
    await driver.findElement(By.name("kota")).clear();
    await driver.sleep(1000);
    await driver.findElement(By.name("kota")).sendKeys("Yahukimo", Key.RETURN);
    await driver.sleep(1000);
    await driver.findElement(By.xpath('//*[@id="modal-edit"]/div/div/div[3]/button[2]')).click();
    //Alert berhasil ubah kota
