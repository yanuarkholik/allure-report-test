...
describe ('SIMPATIK', function() {
  ...
  it('KOTA', async function() {
    ...
    await driver.sleep(3000);
    //Cari Kota
    await driver.findElement(By.className("form-control px-10")).sendKeys("yahukimo", Key.ENTER);
    await driver.sleep(1000);
    //Hapus Kota
    await driver.findElement(By.xpath("/html/body/div[5]/div/div[2]/div[3]/div/div/table/tbody/tr[2]/td[5]/div/button[3]")).click();
    await driver.sleep(1000);
    await driver.findElement(By.className("btn bg-green-600 text-white w-24")).click();
    await driver.sleep(1000);
    //Alert Hapus
