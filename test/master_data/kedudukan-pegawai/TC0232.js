...
describe('MASTER DATA KEDUDUKAN PEGAWAI', function() {
  ...
  it('[Kedudukan Pegawai] Administrator dapat mengurutkan Kedudukan Pegawai secara descending ', async function() {
    ...
    expect(lower_case_kedudukan).to.be.sorted({descending:true});
