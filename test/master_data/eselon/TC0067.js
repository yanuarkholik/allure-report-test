...
describe('MASTER DATA ESELON', function() {
  ...
  it('Dapat melakukan pencarian Eselon berdasarkan kata yang sesuai', async function() {
    ...
    // Search
    await driver.findElement(By.css("input[placeholder='Cari Eselon']")).sendKeys('II.A');
    await driver.sleep(1000);
    await driver.findElement(By.xpath("//*[@class='box']/form/div/div[2]/button")).click()
    await driver.sleep(3000);
        
    let diklat = await driver.findElement(By.xpath("//*[@class='box']/div/div/table/tbody/tr[1]/td[3]")).getText();
    expect(diklat).to.equal('II.A');
  })
})
