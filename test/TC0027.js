...
describe('XL Single Approval', function() {
  ...
  it('Inter Office Memo Submit Request Approval', async function() {
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-option-23 > span")).click();
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-85")).click(); 
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-114")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-182")).click();
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.id("mat-option-309")).click();
    await driver.sleep(2000);
