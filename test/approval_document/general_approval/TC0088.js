...
describe('XL Single Approval', function() {
  ...
  it('Submit Revised Document - Homepass Request', async function() {
    ...
    await driver.sleep(2000);
    await driver.findElement(By.css("#email")).sendKeys('mba.dindaputria@xl.co.id');
    ...
    await driver.sleep(6000);
    await driver.findElement(By.xpath('//*[@id="mat-tab-content-0-0"]/div/div[5]/div/div/div/div/textarea')).sendKeys("HR Revised");
    await driver.sleep(2000);
