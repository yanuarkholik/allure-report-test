...
describe('XL Single Approval', function() {
  ...
  it('Submit Revised Document - SOP', async function() {
    ...
    await driver.sleep(5000);
    await driver.findElement(By.css("#mat-tab-content-0-0 > div > div:nth-child(4) > div > div > div > div > textarea")).sendKeys("SOP Revised");
    await driver.sleep(2000);
    ...
    await driver.sleep(5000);
    await driver.findElement(By.xpath('//*[@id="kt_wizard_v1"]/div[2]/div/form/div[1]/div/div[5]/div/textarea')).sendKeys(" ");
    await driver.sleep(2000);
