...
describe('XL Single Approval', function() {
  ...
  it('IOM Reject - 1 Layer', async function() {
    ...
    await driver.findElement(By.xpath('//*[@id="kt_body"]/ngb-modal-window/div/div/app-edit-approval-document-modal/div/div[2]/button[1]')).click();
    await driver.sleep(5000);
