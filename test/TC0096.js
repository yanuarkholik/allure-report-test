...
describe('XL Single Approval', function() {
  ...
  it('Commerse Payment Dasboard	- Search Commerse Payment Dashboard', async function() {
    ...
    await driver.findElement(By.xpath('//*[@id="kt_content"]/div/div/app-commerce-payment-dashboard/div[2]/div/div/div[1]/div[2]/div/div/input')).sendKeys('PC/MR/Digital_Platform/102022/010');
